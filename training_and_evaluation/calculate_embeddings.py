...
def calculate_embeddings(split_path,dataset_path,data_model_code,path_to_weights):
        ...
        model, preprocess = from_model(path_to_weights)
...
if __name__=="__main__":
    ...
    # do it for trained clip with projection layers 
    #calculate_embeddings("test_deepl.csv",original_path,"plo",path_to_weights_plo)
    #calculate_embeddings("test_deepl.csv",original_path,"plo",path_to_weights_plo)
    calculate_embeddings("test_deepl.csv",original_path,"tlo",path_to_weights_tlo)

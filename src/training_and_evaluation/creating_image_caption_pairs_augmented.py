...
if __name__=="__main__":
    ...
    total_df = pd.read_csv(train_deepl_path)
    ...
    train_df.to_csv(train_deepl_path)
    val_df.to_csv()
...
if __name__=="__main__" :
    ...
    dup_cleaner = DuplicateCleaner(train_deepl_path)
    clean_augmented_train = dup_cleaner()

    # save the train csv 
    clean_augmented_train.to_csv(train_deepl_path)
